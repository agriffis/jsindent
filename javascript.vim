...
if !exists('g:jsindent_wip')
  let g:jsindent_wip = 0
endif

function! GetJsIndent(lnum)
  if g:jsindent_wip
    python reload(vimjsindent)
  endif
  return PyEval('vimjsindent.get_indent('.a:lnum.')')
endfunction
